  ...
  <div class="container" data-aos="fade-up">
    ...
    <div class="row justify-content-center">
      <div class="col-lg-12 col-xl-7">
        <div class="card testimonials section-bg">
          <div class="card-body p-5">
            ...
            <div class="border-top border-gray-200 pt-4 mt-4">
              <div class="row">
                <div class="col-md-6">
                  <div class="text-muted mb-2">No Pembayaran</div>
                  <strong>#<?php echo $id_periksa; ?></strong>
                </div>
                <div class="col-md-6 text-md-end">
                  <div class="text-muted mb-2">Waktu Pembayaran</div>
            ...
            <table class="table border-bottom border-gray-200 mt-3">
              ...
              <tbody>
                <tr>
                  ...
                  <td class="text-end px-0"><?php echo 'Rp ' . number_format(100000, 2, ',', '.'); ?></td>
                </tr>
                <tr>
                   <?php
            ...
            <div class="mt-5">
              <div class="d-flex justify-content-end">
                ...
                <span><?php echo 'Rp ' . number_format(100000, 2, ',', '.'); ?></span>
              </div>
              <div class="d-flex justify-content-end">
                <p class="text-muted me-3">Subtotal Obat :</p>
                <span><?php echo 'Rp ' . number_format($total_harga, 2, ',', '.'); ?></span>
              </div>
              <div class="hoyy text-dark bg-white d-flex justify-content-end mt-1">
                <h4>Total bayar :</h4>
                <h4><?php echo 'Rp ' . number_format($total, 2, ',', '.'); ?></h4>
              </div>
            </div>
          </div>
        </div>
